...
suspend fun PolygonStocksClient.getHistoricQuotes(params: HistoricQuotesParameters): HistoricQuotesDTO =
...
data class HistoricQuotesDTO(
    ...
    val results: List<HistoricQuoteDTO> = emptyList()
)
...
data class HistoricQuoteDTO(
    ...
    @SerialName("x") val bidExchangeId: Long? = null,
    @SerialName("s") val bidSize: Long? = null,
    @SerialName("P") val askPrice: Double? = null,
    @SerialName("X") val askExchangeId: Long? = null,
    @SerialName("S") val askSize: Long? = null,
    @SerialName("z") val tape: Int? = null
)